...
<tr>
    ...
    <td>Club:</td>
             <td>
                <select name="club">
                <option value="None" name="dept">None</option>
                    <option value="APAC" name="dept">APAC</option>
                    <option value="AFC" name="dept">AFC</option>
                    <option value="SOMOY" name="dept">SOMOY</option>
                    <option value="ESAB" name="dept">ESAB</option>
                    <option value="AEC" name="dept">AEC</option>
                    <option value="ACPC" name="dept">ACPC</option>
</select>
</td>  
